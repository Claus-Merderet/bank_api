 ...
 */
final class Version20251116200257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE credit (id SERIAL NOT NULL, account_id INT NOT NULL, amount DOUBLE PRECISION NOT NULL, term_months INT NOT NULL, balance DOUBLE PRECISION NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1CC16EFE9B6B5FBA ON credit (account_id)');
        $this->addSql('CREATE TABLE transaction (id SERIAL NOT NULL, to_account_id INT DEFAULT NULL, from_account_id INT DEFAULT NULL, credit_id INT DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, transaction_type VARCHAR(20) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
